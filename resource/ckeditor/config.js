...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Underline,Subscript,Superscript,Maximize,RemoveFormat,Scayt,SpecialChar,Format,About,Blockquote,NumberedList,BulletedList,Indent,Outdent,Cut,Copy,Paste,PasteText,PasteFromWord,HorizontalRule,Anchor';
};
*/
CKEDITOR.editorConfig = function( config ) {
